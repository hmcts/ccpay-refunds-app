...
public class RefundsApproverJourneyFunctionalTest {
    ...
    public void positive_reject_a_refund_request() {
        ...
        paymentTestService
                .deletePayment(USER_TOKEN_ACCOUNT_WITH_SOLICITORS_ROLE,
                SERVICE_TOKEN_CMC, paymentReference, testConfigProperties.basePaymentsUrl).then()
    ...
    public void positive_resubmit_refund_journey() {
        ...
        paymentTestService
                .deletePayment(USER_TOKEN_ACCOUNT_WITH_SOLICITORS_ROLE,
                SERVICE_TOKEN_CMC, paymentReference1, testConfigProperties.basePaymentsUrl)
    ...
    public void positive_refund_list_for_ccd_case_number_journey() {
        ...
        PaymentDto paymentsResponse =
                paymentTestService
                        .getPbaPayment(USER_TOKEN_PAYMENTS_REFUND_REQUESTOR_ROLE, SERVICE_TOKEN_PAY_BUBBLE_PAYMENT,
        ...
        // delete payment record
        paymentTestService.deletePayment(USER_TOKEN_ACCOUNT_WITH_SOLICITORS_ROLE,
                SERVICE_TOKEN_CMC, paymentDto.getReference(),
    ...
    private String performRefundByApprover() {
        ...
        PaymentDto paymentsResponse =
                paymentTestService
                        .getPbaPayment(USER_TOKEN_PAYMENTS_REFUND_APPROVER_ROLE, SERVICE_TOKEN_PAY_BUBBLE_PAYMENT,
                                paymentDto.getReference(),
                                testConfigProperties.basePaymentsUrl).then()
                        .statusCode(OK.value()).extract().as(PaymentDto.class);
